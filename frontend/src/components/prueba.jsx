      ...
      <main className="admin-main">
        <aside className="sidebar">
          ...
          <details>
            ...
            <button onClick={() => alert("Desde Teams (demo)")}>
              Desde Teams
            </button>
            <button onClick={() => alert("Desde PowerPoint (demo)")}>
              Desde PowerPoint
            </button>
            <button onClick={() => alert("Desde archivo (demo)")}>
              Desde archivo
            </button>
            <button onClick={() => alert("Guardar video (demo)")}>
              Guardar
            </button>
            <button onClick={() => alert("Editar video (demo)")}>
              Editar
            </button>
            <button onClick={() => alert("Eliminar video (demo)")}>
              Eliminar
            </button>
          </details>
          ...
          <details>
            ...
            <button onClick={() => alert("Guardar documento (demo)")}>
              Guardar
            </button>
            <button onClick={() => alert("Editar documento (demo)")}>
              Editar
            </button>
            <button onClick={() => alert("Eliminar documento (demo)")}>
              Eliminar
            </button>
          </details>
          ...
          <details>
            ...
            <button onClick={() => alert("Seleccionar Curso (demo)")}>
              Seleccionar Curso
            </button>
            <button onClick={() => alert("Guardar certificado (demo)")}>
              Guardar
            </button>
            <button onClick={() => alert("Editar certificado (demo)")}>
              Editar
            </button>
            <button onClick={() => alert("Eliminar certificado (demo)")}>
              Eliminar
            </button>
          </details>
        ...
        <section className="section-funcionalidades">
          <div className="title-row">
            <h2>
              Mirar Curso: {selectedCourse ? selectedCourse.title : "Título"}
            </h2>
